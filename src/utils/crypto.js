 ...
 * @returns {Promise<{ciphertext: string, iv: string}>} 暗号文とIV（Base64エンコード）
 */
 ...
 * @param {{ciphertext: string, iv: string}} encryptedData - 暗号化データ
 * @param {CryptoKey} key - 暗号化キー
 * @returns {Promise<string>} 復号された平文
 */
 ...
 * @param {CryptoKey} key - 暗号化キー
 * @returns {Promise<{ciphertext: string, iv: string}>} 暗号化されたAPIキー
 */
 ...
 * @param {{ciphertext: string, iv: string} | string} encryptedApiKey - 暗号化されたAPIキーまたは平文
 * @param {CryptoKey} key - 暗号化キー
