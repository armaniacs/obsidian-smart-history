 ...
 */
export function setupAllFieldValidations(protocolInput, portInput, minVisitDurationInput, minScrollDepthInput) {
    return [
 ...
 */
export function validateAllFields(protocolInput, portInput, minVisitDurationInput, minScrollDepthInput) {
    let hasError = false;
    if (!validateProtocol(protocolInput))
        hasError = true;
    if (!validatePort(portInput))
        hasError = true;
    if (!validateMinVisitDuration(minVisitDurationInput))
        hasError = true;
    if (!validateMinScrollDepth(minScrollDepthInput))
        hasError = true;
    return !hasError;
}
