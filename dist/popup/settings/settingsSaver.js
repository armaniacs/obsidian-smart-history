 ...
 */
export async function handleSaveAndTest(statusDiv, protocolInput, portInput, minVisitDurationInput, minScrollDepthInput, settingsMapping, validateFn) {
 ...
 */
export function setupSaveButtonListener(saveBtn, statusDiv, protocolInput, portInput, minVisitDurationInput, minScrollDepthInput, settingsMapping) {
    const handler = async () => {
        await handleSaveAndTest(statusDiv, protocolInput, portInput, minVisitDurationInput, minScrollDepthInput, settingsMapping, (p1, p2, p3, p4) => {
            // デフォルトバリデーション
...
//# sourceMappingURL=settingsSaver.js.map