 ...
 */
declare const SCREEN_STATES: Readonly<{
    readonly MAIN: "main";
 ...
 * 🟢 要求定義（tdd-requirements.md 49-52行目、screenState型定義）
 */
export declare function getScreenState(): ScreenState;
/**
 * 【機能概要】: 画面状態を設定
 ...
 * 🟢 要求定義（tdd-requirements.md 49-52行目、screenState型定義）
 */
export declare function setScreenState(state: ScreenState): void;
/**
 * 【機能概要】: 画面状態を初期値に戻す
 * 【設計方針】: モジュール初期化時やテストクリーンアップ時に使用
 * 🟢 要求定義に基づき初期状態を'main'とするアプローチ
 */
export declare function clearScreenState(): void;
/**
