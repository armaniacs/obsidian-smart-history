 ...
 */
function findMatchedPattern(domain, domainList) {
 ...
 */
async function fetchCacheControlHeader(url) {
    try {
...
export async function checkPageStatus(url) {
    // 特殊URLのチェック
    ...
    try {
        ...
        // ドメインフィルタチェック
        const mode = (settings.domain_filter_mode || 'disabled');
