...
export async function init() {
    ...
    await loadAndDisplaySources((sources) => {
        renderSourceList(sources, handleDeleteSource, handleReloadSource);
    });
}
// ============================================================================
// テキスト入力プレビュー機能
...
async function handleReloadSource(index) {
    ...
    try {
        ...
        renderSourceList(currentSources, handleDeleteSource, handleReloadSource);
    }
}
/**
 * uBlock設定の保存メインハンドラ
...
export function setupDragAndDrop() {
    ...
    if (!dropZone || !textarea || !uBlockFormatUI)
        return;
