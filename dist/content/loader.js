 ...
 */
async function checkDomainAllowedFromCache(url) {
    ...
    const cachedWhitelist = result[StorageKeys.DOMAIN_FILTER_CACHE] || [];
    ...
    if (mode === 'blacklist') {
        ...
        const blacklist = result2[StorageKeys.DOMAIN_BLACKLIST] || [];
