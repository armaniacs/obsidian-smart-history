...
class RuleIndex {
    blockRulesByDomain;
    exceptionRulesByDomain;
    wildcardBlockRules;
    wildcardExceptionRules;
...
function evaluateOptions(rule, context) {
    ...
    if (!opts)
        return true; // No options means rule matches domain.
...
//# sourceMappingURL=ublockMatcher.js.map