...
export class ServiceWorkerContext {
    ...
    getRecordingLogic() {
        if (!this.dependencies.recordingLogic) {
            this.dependencies.recordingLogic = new RecordingLogic(this.dependencies.obsidianClient || this.getObsidianClient(), this.dependencies.aiClient || this.getAIClient(), this.dependencies.privacyPipeline || this.getPrivacyPipeline());
        }
...
//# sourceMappingURL=ServiceWorkerContext.js.map