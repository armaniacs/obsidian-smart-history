...
export interface IObsidianClient {
     ...
     * @param summary - 要約
     */
    recordUrl(url: string, summary: string): Promise<{
        success: boolean;
        message?: string;
    }>;
    /**
...
export interface IRecordingLogic {
     ...
     */
    record(url: string, options?: Record<string, any>): Promise<{
        success: boolean;
        message: string;
    }>;
}
...
export interface IPrivacyPipeline {
     ...
     */
    process(content: string, options?: Record<string, any>): Promise<{
        summary: string;
        preview?: string;
    }>;
}
